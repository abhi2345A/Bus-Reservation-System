# Generated by Django 3.0.2 on 2020-03-25 22:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Window Seat', 'Window Seat'), ('Inner Seat', 'Inner Seat')], default=None, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seat', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='selection.Room')),
                ('user', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
